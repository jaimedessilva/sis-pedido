...
import sisPedido.entities.Payment;
import sisPedido.entities.Product;
import sisPedido.entities.User;
import sisPedido.entities.enums.OrderStatus;
import sisPedido.repositories.CategoryRepository;
import sisPedido.repositories.OrderItemRepository;
...
@Configuration
@Profile("test")
public class TestConfig<T> implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null,"Maria Beltrao","maria@gmail.com","61-9999-8888","123abc");
		User u2 = new User(null,"John Bold","jp@gmail.com","61-9888-8888","123cde");
